...
import { FinnhubPriceService } from '../price-alert/finnhub-price.service'
...
export class TelegramBotService implements OnModuleInit {
  ...
  constructor(
    ...
    @Inject(forwardRef(() => FinnhubPriceService))
    private readonly finnhubPriceService: FinnhubPriceService,
  ...
  private async handleSetAlert(chatId: string, parts: string[]): Promise<void> {
    ...
    if (result.success) {
      this.finnhubPriceService.subscribeToSymbol(symbol)
    }
  }
